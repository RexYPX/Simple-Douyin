...
type Client interface {
	...
	Userid2VideoList(ctx context.Context, req *feed.Userid2VideoListRequest, callOptions ...callopt.Option) (r *feed.Userid2VideoListResponse, err error)
}
...
func (p *kFeedServiceClient) Userid2VideoList(ctx context.Context, req *feed.Userid2VideoListRequest, callOptions ...callopt.Option) (r *feed.Userid2VideoListResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.Userid2VideoList(ctx, req)
}
