...
type Userid2VideoListRequest struct {
	UserId int64 `thrift:"user_id,1" frugal:"1,default,i64" json:"user_id"`
}

func NewUserid2VideoListRequest() *Userid2VideoListRequest {
	return &Userid2VideoListRequest{}
}

func (p *Userid2VideoListRequest) InitDefault() {
	*p = Userid2VideoListRequest{}
}

func (p *Userid2VideoListRequest) GetUserId() (v int64) {
	return p.UserId
}
func (p *Userid2VideoListRequest) SetUserId(val int64) {
	p.UserId = val
}

var fieldIDToName_Userid2VideoListRequest = map[int16]string{
	1: "user_id",
}

func (p *Userid2VideoListRequest) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_Userid2VideoListRequest[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *Userid2VideoListRequest) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return err
	} else {
		p.UserId = v
...
func (p *Userid2VideoListRequest) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("Userid2VideoListRequest"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *Userid2VideoListRequest) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *Userid2VideoListRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("Userid2VideoListRequest(%+v)", *p)
}

func (p *Userid2VideoListRequest) DeepEqual(ano *Userid2VideoListRequest) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *Userid2VideoListRequest) Field1DeepEqual(src int64) bool {
...
type Userid2VideoListResponse struct {
	VideoList []*Video `thrift:"video_list,1" frugal:"1,default,list<Video>" json:"video_list"`
}

func NewUserid2VideoListResponse() *Userid2VideoListResponse {
	return &Userid2VideoListResponse{}
}

func (p *Userid2VideoListResponse) InitDefault() {
	*p = Userid2VideoListResponse{}
}

func (p *Userid2VideoListResponse) GetVideoList() (v []*Video) {
	return p.VideoList
}
func (p *Userid2VideoListResponse) SetVideoList(val []*Video) {
	p.VideoList = val
}

var fieldIDToName_Userid2VideoListResponse = map[int16]string{
	1: "video_list",
}

func (p *Userid2VideoListResponse) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_Userid2VideoListResponse[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *Userid2VideoListResponse) ReadField1(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
...
func (p *Userid2VideoListResponse) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("Userid2VideoListResponse"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *Userid2VideoListResponse) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *Userid2VideoListResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("Userid2VideoListResponse(%+v)", *p)
}

func (p *Userid2VideoListResponse) DeepEqual(ano *Userid2VideoListResponse) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *Userid2VideoListResponse) Field1DeepEqual(src []*Video) bool {
...
type FeedService interface {
	...
	Userid2VideoList(ctx context.Context, req *Userid2VideoListRequest) (r *Userid2VideoListResponse, err error)
}
...
func (p *FeedServiceClient) Userid2VideoList(ctx context.Context, req *Userid2VideoListRequest) (r *Userid2VideoListResponse, err error) {
	var _args FeedServiceUserid2VideoListArgs
	_args.Req = req
	var _result FeedServiceUserid2VideoListResult
	if err = p.Client_().Call(ctx, "Userid2VideoList", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewFeedServiceProcessor(handler FeedService) *FeedServiceProcessor {
	...
	self.AddToProcessorMap("Userid2VideoList", &feedServiceProcessorUserid2VideoList{handler: handler})
	return self
}
...
type feedServiceProcessorUserid2VideoList struct {
	handler FeedService
}

func (p *feedServiceProcessorUserid2VideoList) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := FeedServiceUserid2VideoListArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("Userid2VideoList", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := FeedServiceUserid2VideoListResult{}
	var retval *Userid2VideoListResponse
	if retval, err2 = p.handler.Userid2VideoList(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing Userid2VideoList: "+err2.Error())
		oprot.WriteMessageBegin("Userid2VideoList", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("Userid2VideoList", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type FeedServiceUserid2VideoListArgs struct {
	Req *Userid2VideoListRequest `thrift:"req,1" frugal:"1,default,Userid2VideoListRequest" json:"req"`
}

func NewFeedServiceUserid2VideoListArgs() *FeedServiceUserid2VideoListArgs {
	return &FeedServiceUserid2VideoListArgs{}
}

func (p *FeedServiceUserid2VideoListArgs) InitDefault() {
	*p = FeedServiceUserid2VideoListArgs{}
}

var FeedServiceUserid2VideoListArgs_Req_DEFAULT *Userid2VideoListRequest

func (p *FeedServiceUserid2VideoListArgs) GetReq() (v *Userid2VideoListRequest) {
	if !p.IsSetReq() {
		return FeedServiceUserid2VideoListArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *FeedServiceUserid2VideoListArgs) SetReq(val *Userid2VideoListRequest) {
	p.Req = val
}

var fieldIDToName_FeedServiceUserid2VideoListArgs = map[int16]string{
	1: "req",
}

func (p *FeedServiceUserid2VideoListArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *FeedServiceUserid2VideoListArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FeedServiceUserid2VideoListArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *FeedServiceUserid2VideoListArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewUserid2VideoListRequest()
	if err := p.Req.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *FeedServiceUserid2VideoListArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("Userid2VideoList_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *FeedServiceUserid2VideoListArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *FeedServiceUserid2VideoListArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("FeedServiceUserid2VideoListArgs(%+v)", *p)
}

func (p *FeedServiceUserid2VideoListArgs) DeepEqual(ano *FeedServiceUserid2VideoListArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *FeedServiceUserid2VideoListArgs) Field1DeepEqual(src *Userid2VideoListRequest) bool {
...
type FeedServiceUserid2VideoListResult struct {
	Success *Userid2VideoListResponse `thrift:"success,0,optional" frugal:"0,optional,Userid2VideoListResponse" json:"success,omitempty"`
}

func NewFeedServiceUserid2VideoListResult() *FeedServiceUserid2VideoListResult {
	return &FeedServiceUserid2VideoListResult{}
}

func (p *FeedServiceUserid2VideoListResult) InitDefault() {
	*p = FeedServiceUserid2VideoListResult{}
}

var FeedServiceUserid2VideoListResult_Success_DEFAULT *Userid2VideoListResponse

func (p *FeedServiceUserid2VideoListResult) GetSuccess() (v *Userid2VideoListResponse) {
	if !p.IsSetSuccess() {
		return FeedServiceUserid2VideoListResult_Success_DEFAULT
	}
	return p.Success
}
func (p *FeedServiceUserid2VideoListResult) SetSuccess(x interface{}) {
	p.Success = x.(*Userid2VideoListResponse)
}

var fieldIDToName_FeedServiceUserid2VideoListResult = map[int16]string{
	0: "success",
}

func (p *FeedServiceUserid2VideoListResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *FeedServiceUserid2VideoListResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FeedServiceUserid2VideoListResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *FeedServiceUserid2VideoListResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewUserid2VideoListResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *FeedServiceUserid2VideoListResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("Userid2VideoList_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *FeedServiceUserid2VideoListResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *FeedServiceUserid2VideoListResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("FeedServiceUserid2VideoListResult(%+v)", *p)
}

func (p *FeedServiceUserid2VideoListResult) DeepEqual(ano *FeedServiceUserid2VideoListResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *FeedServiceUserid2VideoListResult) Field0DeepEqual(src *Userid2VideoListResponse) bool {
