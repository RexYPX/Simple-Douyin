...
type Ids2ListRequest struct {
	...
	MUserId int64   `thrift:"m_user_id,3" frugal:"3,default,i64" json:"m_user_id"`
}
...
func (p *Ids2ListRequest) GetMUserId() (v int64) {
	return p.MUserId
}
...
func (p *Ids2ListRequest) SetMUserId(val int64) {
	p.MUserId = val
}
...
func (p *Ids2ListRequest) ReadField3(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return err
	} else {
		p.MUserId = v
...
func (p *Ids2ListRequest) writeField3(oprot thrift.TProtocol) (err error) {
...
func (p *Ids2ListRequest) DeepEqual(ano *Ids2ListRequest) bool {
	...
	if !p.Field3DeepEqual(ano.MUserId) {
		return false
	}
	return true
}
...
func (p *Ids2ListRequest) Field3DeepEqual(src int64) bool {
